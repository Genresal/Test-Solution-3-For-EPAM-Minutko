...
namespace EMR.Controllers
{
    public class TreatmentController : Controller
    {
        ...
        {
            var result = _pageService.LoadDrugTable(SearchParameters);
        ...
        [HttpPost]
        public IActionResult LoadProcedureTable([FromBody] ProcedureSearchModel SearchParameters)
        {
            var result = _pageService.LoadProcedureTable(SearchParameters);
